...
//
// HOW TO USE:
//   <script src="wods.js"></script>  (before your index.html’s main script)
//   In index.html JS: const BENCH = window.WOD_BANK; const TRIBUTES = window.WOD_TRIBUTES;
//
// Notes:
// - Any barbell/Ring/Rope-climb workout is adapted to DBs and bar muscle-ups or pull-up substitutes.
// - If something is sub-20 for you, add an easy 800–1600m run or 1–2k row to finish in 20–60.
// - “DB1” means single 50; “DB2” means two 50s; KB loads shown. Box is 24" default; scale 20/32.
// - Hero stories included in TRIBUTES (short + respectful).
